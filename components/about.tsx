...
export function About() {
  ...
  const defaultInfo = {
    ...
    experienceCards: [{"icon":"graduation","title":"영남대학교","period":"2003 ~ 2007","description":"정치외교학과, 언론정보학과"},{"icon":"briefcase","title":"울산시청자미디어센터","period":"2022 ~ 현재","description":"미디어 강사"},{"icon":"briefcase","title":"대구시청자미디어센터","period":"2024 ~ 현재","description":"미디어 강사"},{"icon":"briefcase","title":"한국언론진흥재단","period":"2025~ 현재","description":"늘봄 강사"},{"icon":"briefcase","title":"AI콘텐츠랩스","period":"2025","description":"강사"},{"icon":"award","title":"디지털배움터","period":"2024","description":"강사"},{"icon":"award","title":"울산 숏폼 영상 공모전, 우리네 울산을 보다로 대상 수상","period":"2023","description":"울산콘텐츠코리아랩"},{"icon":"award","title":"울산동구 영상공모전, 혹시 방어진을 아시나요? 방어진근대역사찾기로 은상 수상","period":"2023","description":"울산 동구청"},{"icon":"award","title":"충청남도 탄소중립경제 유튜브 공모전, 탄소중립경제 알GO,실천하GO, 함께하GO로 우수상 수상","period":"2023","description":"충청남도"},{"icon":"book","title":"울산 중구 숏폼 영상공모전, 한글도시 울산 중구로 장려상 수상","period":"2023","description":"울산 중구청"},{"icon":"briefcase","title":"디지털 윤리 창작콘텐츠 공모전 [SNS 속 디지털 윤리찾기] 장려상 수상","period":"2025","description":"AI 영상"},{"icon":"briefcase","title":"울산 북구 시그니처 홍보영상 공모전 [소금POP] 동상 수상","period":"2025","description":"AI 영상"},{"icon":"briefcase","title":"새 경험[영상 공모전, 수상비법을 알려주마!] 전자책 출간","period":"2024","description":"설명을 입력하세요"}],
    skills: [{"icon":"camera","title":"촬영 및 편집","description":"전문적인 촬영과 편집이 가능합니다."},{"icon":"video","title":"다양한 영상 제작 ","description":"어린이부터 어르신까지 다양한 계층과 함께 합니다."},{"icon":"star","title":"AI","description":"AI 이미지 제작, 영상 제작, 동화책 출간까지 다양한 분야에서 활동하고 있습니다."},{"icon":"star","title":"디지털 & 미디어 교육","description":"리터러시 교육부터 영상 촬영, 편집, AI까지 \n어르신부터 어린아이까지 교육이 가능합니다."}],
