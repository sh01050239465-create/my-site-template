...
export function Projects() {
  ...
  const defaultInfo = {
    ...
    projects: [{"image":"https://www.youtube.com/watch?v=x42YXBI4f_0","video":"","title":"아름다운 휴식이 있는 울산 슬도","description":"이미지 제작부터 모든 작업을 AI로 한 영상입니다."},{"image":"https://youtube.com/shorts/781SxRjPh_0","video":"","title":"우리네 울산을 보다","description":"대상수상작"},{"image":"https://www.youtube.com/watch?v=W4YGLXLh5WM&list=PLipIhXv1xg0ynCVSQHabq4D_KeRQN9qBN&index=9","video":"","title":"보성학교이야기","description":"JCN방송작"},{"image":"/uploads/project-1764677090472-1764677091654.png","video":"","title":"소금 POP","description":"https://www.youtube.com/watch?v=cGq81VCXQxs&t=1s"}] as Array<{ image: string; video?: string; title: string; description: string }>
  }
